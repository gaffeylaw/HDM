class CreateDipOrganization < ActiveRecord::Migration
  def change
    ...
    execute %{select t.rowid row_id,t."ID" "ORG_ID",t."ORG_NAME",t."P_ORG_ID",t."P_ORG_NAME",t."CREATED_BY",t."UPDATED_BY",t."COMBINATION_RECORD",t."BATCH_ID",t."IDX",t."CREATED_AT",t."UPDATED_AT" from dip_organization t}
