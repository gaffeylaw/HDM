...
class CreateOralcePackage < ActiveRecord::Migration
  ...
  */
  ...
  begin
    ...
    l_sql_insert      := 'insert into ' || l_table_name ||'(batch_id,created_by,updated_by,created_at,updated_at,combination_record';
    l_sql_insert_data := 'select batch_id,created_by,updated_by,created_at,updated_at,combination_record';
