class CreateTemporaryTable40 < ActiveRecord::Migration
  def up
    create_table(:dip_temporary_table_40) do |t|
    ...
    change_column :dip_temporary_table_40, "id", :string, :limit => 32, :collate => "utf8_bin"
    add_index(:dip_temporary_table_40, :batch_id, :name => :dip_temporary_table_40_n1)
    add_index(:dip_temporary_table_40, :template_id, :name => :dip_temporary_table_40_n2)
    add_index(:dip_temporary_table_40,[:batch_id, :target_id],:name=>:dip_temporary_table_40_n3)
  end

  def down
    drop_table :dip_temporary_table_40
  end
end
